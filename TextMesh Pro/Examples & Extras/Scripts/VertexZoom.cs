        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                   ...
                   Vector4[] vector4Array = textInfo.meshInfo[i].uvs0;
                   Vector2[] vector2Array = new Vector2[vector4Array.Length];
                   for (int j = 0; j < vector4Array.Length; j++)
                   {
                       vector2Array[j] = new Vector2(vector4Array[j].x, vector4Array[j].y);
                   }
                   textInfo.meshInfo[i].mesh.uv = vector2Array;
